...
public class MicrosoftPollingResponse {
    ...
    public static class Deserializer implements JsonDeserializer<MicrosoftPollingResponse> {
        ...
        @Override
        public MicrosoftPollingResponse deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
            MicrosoftPollingResponse response = new MicrosoftPollingResponse();
